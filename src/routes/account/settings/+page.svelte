    ...
    <div class="flex min-w-0 flex-col gap-10 lg:col-span-2">
      <Card.Root>
        <Card.Header>
          ...
          <Card.Description>
            ...
            expert directory (as directory features roll out). You can hide it
        ...
        <Card.Content class="space-y-4">
            ...
            >
              <div class="space-y-1">
                ...
                <p class="text-muted-foreground text-sm">
                  Turn off to temporarily remove your profile from directory
                  search and listings.
                </p>
              </div>
              <label
          ...
          {#if !data.listingActive}
            <Alert>
              ...
              <AlertDescription>
                Your profile will not be shown in the directory. You can turn
                this back on whenever you are ready.
              </AlertDescription>
            </Alert>
          {/if}
        </Card.Content>
      ...
      >
        ...
        <p class="text-muted-foreground mt-2 text-sm">
          ...
          listing is turned off, so you do not remove your profile from search
          by mistake.
        </p>

        {#if data.listingActive}
          <p class="text-muted-foreground mt-4 text-sm">
            To delete your account, first turn off <strong
              >Show in directory</strong
            >
        ...
        {:else}
          <div class="mt-6 space-y-4">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Deleting your account removes your login and profile data. This
                is irreversible. Your expert listing and member access will be
                gone.
              </AlertDescription>
            </Alert>
